...
Allows streaming of a flat J\-A\-S\-O\-N formatted string of Boost\-Store contents. \hypertarget{classBStore_a7594a567b2c3d718781efbb0f411888a}{\index{B\-Store@{B\-Store}!operator$>$$>$@{operator$>$$>$}}
\index{operator$>$$>$@{operator$>$$>$}!BStore@{B\-Store}}
\subsubsection[{operator$>$$>$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ void B\-Store\-::operator$>$$>$ (
\begin{DoxyParamCaption}
\item[{T \&}]{obj}
...
\end{DoxyReturn}
\hypertarget{classBStore_adcea1522f4c8adcc92a04a825cb84c3d}{\index{B\-Store@{B\-Store}!operator\mbox{[}$\,$\mbox{]}@{operator[]}}
\index{operator\mbox{[}$\,$\mbox{]}@{operator[]}!BStore@{B\-Store}}
\subsubsection[{operator[]}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Binary\-Stream}$\ast$ B\-Store\-::operator\mbox{[}$\,$\mbox{]} (
\begin{DoxyParamCaption}
\item[{std\-::string}]{key}
...
install/include/B\-Store.\-h\item 
