...
\end{DoxyReturn}
\hypertarget{classStore_a26d26db839f734e0af5404b7dac40dae}{\index{Store@{Store}!Get@{Get}}
\index{Get@{Get}!Store@{Store}}
\subsubsection[{Get}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename T $>$ T Store\-::\-Get (
\begin{DoxyParamCaption}
\item[{std\-::string}]{name}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classStore_a26d26db839f734e0af5404b7dac40dae}
...
\end{DoxyReturn}
\hypertarget{classStore_a41eaa81c4612fb5bdbf850afb6428977}{\index{Store@{Store}!Has@{Has}}
\index{Has@{Has}!Store@{Store}}
\subsubsection[{Has}]{\setlength{\rightskip}{0pt plus 5cm}bool Store\-::\-Has (
\begin{DoxyParamCaption}
\item[{std\-::string}]{key}
\end{DoxyParamCaption}
)}}\label{classStore_a41eaa81c4612fb5bdbf850afb6428977}
...
\hline
\end{DoxyParams}
\hypertarget{classStore_a5247080901fb214804d0191681a30a83}{\index{Store@{Store}!Initialise@{Initialise}}
\index{Initialise@{Initialise}!Store@{Store}}
\subsubsection[{Initialise}]{\setlength{\rightskip}{0pt plus 5cm}bool Store\-::\-Initialise (
\begin{DoxyParamCaption}
\item[{std\-::string}]{filename}
\end{DoxyParamCaption}
)}}\label{classStore_a5247080901fb214804d0191681a30a83}
